...
class UserFeedback:
    ...
    def show_workflow_guide(self, steps: List[Dict[str, str]], current_step: int = 0):
        ...
        for i, step in enumerate(steps):
            ...
            <div style="padding: 10px; margin: 5px 0; border-left: 4px solid {status_color}; 
                        background: {'#f8f9fa' if i == current_step else '#ffffff'};">
